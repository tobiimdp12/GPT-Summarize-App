  ...
  return (
    <section className='mt-16 w-full max-w-xl'>
      ...
      <div className='flex flex-col w-full gap-2'>
        ...
        {/* Browse History */}
        <div className='flex flex-col gap-1 max-h-60 overflow-y-auto bg-white'>
          ...
          article.summary && (
            <div className='flex flex-col gap-3'>
              <h2 className='font-satoshi font-bold text-white text-2xl'>
                Article <span className='result_gradient'>Summary</span>
              </h2>
              <div className='summary_box animate__animated animate__backInLeft'>
